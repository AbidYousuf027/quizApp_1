let htmlQuiz = [
  ...
  let quizDisplay = document.getElementById("quizSection");
  ...
  function showQuestion() {
    ...
    for (let i = 0; i < htmlQuiz[indexValue].options.length; i++) {
      let optionValue = htmlQuiz[indexValue].options[i];
      let correctValue = htmlQuiz[indexValue].correctAnswer;
